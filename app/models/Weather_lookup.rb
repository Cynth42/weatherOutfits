class WeatherLookup
    ...
    def hourly_temperature(hourly_weather_hash)
        ...
        self.feels_like = hourly_forecast_response['feelslike']['english']
        self.chance_of_rain = hourly_forecast_response['pop']
        self.chance_of_snow = hourly_forecast_response['snow']['english']
        self.windchill = hourly_forecast_response['windchill']['english']
        self.wind_dir = hourly_forecast_response['wdir']['dir']
        self.humidity = hourly_forecast_response['humidity']
        self.dew_point = hourly_forecast_response['dewpoint']['english']
        self.heat_index = hourly_forecast_response['heatindex']['english']
    ...
    def week_forecast(week_weather_hash)
        ...
        self.day_one_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][0]['icon_url']
        ...
        self.day_two_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][1]['icon_url']
        ...
        self.day_three_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][2]['icon_url']
        ...
        self.day_four_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][3]['icon_url']
        ...
        self.day_five_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][4]['icon_url']
        ...
        self.day_six_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][5]['icon_url']
        ...
        self.day_seven_icon = weekly_forecast_response['simpleforecast']['forecastdays']['forecastday'][6]['icon_url']
    end
