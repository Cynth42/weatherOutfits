			...
			success : function(parsed_json) {
				...
				$.ajax({
					...
					success : function(data) {
						...
						$("<h2>").html("Forecast is " + weather + ". The Relative Humidity is " + relative_humidity + ". Wind Direction is " + wind_dir + ". Wind is " + wind_string + ". Precipitation is " + precip_1hr_string + ". Visibility is " + visibility_mi + ". Pressure: " + pressure_in + " and UV is " + UV ).appendTo(".api-result");
